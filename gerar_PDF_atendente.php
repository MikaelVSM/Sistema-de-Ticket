...
$dados .= "</head>";
$dados .= "<body>";
$dados .= "<h1>Atendentes</h1>";

// Incluir conexao com banco de dados
include_once './config.php';

// Query para recuperar os registros do banco de dados
$query_usuarios =  "SELECT id_usuario, nome_usuario, tipo_usuario, nome_departamento from usuario as u
                    INNER JOIN usuario_departamento as ud
...
mysqli_stmt_bind_result($result_usuarios, $id_usuario, $nome_usuario, $tipo_usuario, $nome_departamento);

// Iniciar a tabela
$dados .= "<table>";
$dados .= "<tr><th>ID do Usuário</th><th>Nome do Usuário</th><th>Nome do Departamento</th></tr>";


// Ler os registros retornados do BD
while(mysqli_stmt_fetch($result_usuarios)){
    $dados .= "<tr><td>$id_usuario</td><td>$nome_usuario</td><td>$nome_departamento</td></tr>";
}
