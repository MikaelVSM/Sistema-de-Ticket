...
// Iniciar a tabela
$dados .= "<table>";
$dados .= "<tr><th>ID Ticket</th><th>Nome do Departamento</th><th>Nome do Usuário</th><th>Título do Ticket</th><th>Descrição</th><th>Data</th><th>Hora</th><th>Status</th></tr>";

// Ler os registros retornados do BD
while(mysqli_stmt_fetch($result_usuarios)){
    $status = $status_ticket == 1 ? "": "Aberto";
